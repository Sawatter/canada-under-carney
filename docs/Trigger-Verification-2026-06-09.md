...
- **Trigger:** "Temporary residents reach the 5% target ahead of schedule" (up).
- **External evidence:** StatCan Q4 2025 (Jan 1, 2026): 2,676,441 non-permanent residents / 41,472,081 total = **~6.5%**, down ~171K in the quarter. Target is below 5% by end of 2027 (revised from end-2026).
- **Read:** Up-trigger **not fired** — share is ~1.5 points above target with the deadline 18+ months out. Hold at C+ (trend up, contracting) corroborated.
