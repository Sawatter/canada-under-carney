...
- **Depends on:** [docs/Scoring-Rubric-v1.1.md](<repo root>/docs/Scoring-Rubric-v1.1.md), [docs/Source-Authority-Map.md](<repo root>/docs/Source-Authority-Map.md), [docs/Commitment-Traceability-Map.md](<repo root>/docs/Commitment-Traceability-Map.md), [docs/QA-Gatekeeping-Rules.md](<repo root>/docs/QA-Gatekeeping-Rules.md), [docs/v2/verification/Claude-House-Style.md](<repo root>/docs/v2/verification/Claude-House-Style.md)
- **Used by:** roadmap triage in [docs/Current-Roadmap.md](<repo root>/docs/Current-Roadmap.md), [docs/Parking-Lot.md](<repo root>/docs/Parking-Lot.md) triage, feature scoping, stage-boundary reviews for new features or artifacts.

---

## Positioning

This document governs **what** the project optimizes for. [docs/v2/verification/Claude-House-Style.md](<repo root>/docs/v2/verification/Claude-House-Style.md) governs **how** that work is executed. The two are complementary and both apply to any non-trivial change.
