...
- [Claude-House-Style.md](<repo root>/docs/v2/verification/Claude-House-Style.md)
- [Claude-Session-Discipline.md](<repo root>/docs/v2/verification/Claude-Session-Discipline.md)
- this protocol
