...
| Jan 1, 2026 (Q4 2025 reference date) | 2,676,441 | ~41.8M | **~6.4%** | [The Daily, Q4 2025 release Mar 18, 2026](https://www150.statcan.gc.ca/n1/daily-quotidien/260318/dq260318b-eng.htm) |
...
- Jan 1, 2026: 6.4% (−0.4 pp)

**Average decline per quarter:** ~0.4 pp.

**Linear projection if pace continues:**
- Apr 1, 2026 (Q1 reference): ~6.0%
- Jul 1, 2026 (Q2 reference): ~5.6%
- Oct 1, 2026 (Q3 reference): ~5.2%
- Jan 1, 2027 (Q4 reference, "end of 2026"): ~4.8%
...
| Test | Status |
|---|---|
| Has TR share reached 5%? | NO — currently 6.4% (Jan 1, 2026 reference date). |
| Is the trajectory consistent with reaching 5% before end of 2026? | YES — linear extrapolation puts TR share below 5% by Q4 2026 reference date (Jan 1, 2027). |
| Is "ahead of schedule" satisfied? | NOT YET. Target is end-of-2026; current data does not yet confirm early arrival. |
...
5. **Add the Jan 1, 2026 / 6.4% data point** to Immigration metric chain as the most recent confirmed reading.
