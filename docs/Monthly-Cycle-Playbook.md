...
- **Hardening acceptance:** commit `d1c49f7` was pushed on 2026-08-30 after local gates passed and the final Claude review exited 0 with `VERDICT: APPROVED`. Hosted backtest run `33341015470` failed on insufficient Anthropic API credit. Its privacy gates passed, but its diagnostic ledger is not accepted, state advancement was blocked, and review-branch publication was skipped. The September 5 retry also failed, and the editor then ruled out paid Anthropic API use. Do not retry or set up a paid key. Hosted acceptance remains open. The editor approved manual source review for September and paused the hosted scout. This does not count as hosted acceptance. Live monthly acceptance remains separate. Exact inputs and artifact: [Source-Monitoring-System.md](Source-Monitoring-System.md#hosted-acceptance-2026-08-30).
