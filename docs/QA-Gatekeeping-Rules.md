...
**Carry-forward note:** If a claim was already implemented and is being carried forward from a prior cycle rather than newly introduced, apply [docs/v2/verification/Carry-Forward-Rules.md](<repo root>/docs/v2/verification/Carry-Forward-Rules.md) to determine whether re-verification is required.
...
**Probationary note:** Whole-letter probationary dimensions and plus/minus-collapse mechanics are governed by [docs/Plus-Minus-Decision-Rules.md](<repo root>/docs/Plus-Minus-Decision-Rules.md). Apply Rule 5 here only after the probationary display/precision rule has been resolved there.
...
- **Claim-level verification mechanics** — [docs/v2/verification/Source-Verification-Protocol.md](<repo root>/docs/v2/verification/Source-Verification-Protocol.md)
...
- **Per-source-family characterization (institution type, ownership, editorial independence, tier assignment, best-use boundary)** — [docs/Source-Characterization-Register.md](<repo root>/docs/Source-Characterization-Register.md)
